...
<?php
    ...
    $sentencia = $bd -> query("select * from secciones");
                ...
                <div class="p-4">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td scope="row"><?php echo $dato->id_seccion; ?></td>
                                <td><?php echo $dato->year_registro_seccion; ?></td>
                                <td><?php echo $dato->year_carrera_seccion; ?></td>
                                <td><?php echo $dato->letra_seccion; ?></td>
                                <td><a class="text-success" href="editar.php?codigo=<?php echo $dato->id_seccion; ?>"><i class="bi bi-pencil-square"></i></a></td>
                                <td><a onclick="return confirm('Estas seguro de eliminar?');" class="text-danger" href="eliminar.php?codigo=<?php echo $dato->id_seccion; ?>"><i class="bi bi-trash"></i></a></td>
                            </tr>
