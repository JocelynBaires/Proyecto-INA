...
$SQL = "SELECT * FROM alumnos INNER JOIN secciones ON alumnos.seccion_alumno = secciones.id_seccion";
...
while ($fila = $objeto->fetch_assoc()) {
    ...
    $Datos = <<<tabla
        ...
        <form name="formulario" method="post" action="Alumno_crear_confirmado.php">
            <div class="row g-2">
                ...
                <div class="form-group" style="display:none;">
                    ...
                    <input type="" name="id_alumno" value="" id="id_alumno" class="form-control" placeholder="Servicios, Telecomunicaciones, etc." minlength="5" maxlength="40">
                </div>
                <div class="form-group">
                    <label class="">Nombre del Alumno:</label>
                    <input type="" name="nombre_alumno" value="" id="nombre_alumno" class="form-control" placeholder="Nombre del alumno." minlength="5" maxlength="40" >
                </div>
                <div class="form-group">
                    <label class="">Nombre del Alumno:</label>
                    <input type="" name="apellido_alumno" value="" id="apellido_alumno" class="form-control" placeholder="Apellido del alumno" minlength="5" maxlength="40" >
                </div>
                <div class="form-group">
                    <label class="">Carrera del Alumno:</label>
                    <input type="" name="carrera_alumno" value="" id="carrera_alumno" class="form-control" placeholder="Estudio del alumno" minlength="5" maxlength="100" >
                </div>
                <div class="form-group">
...
<br><br>
<input class="btn btn-dark" type="submit" value="Guardar Información de Alumno." />
</form>
